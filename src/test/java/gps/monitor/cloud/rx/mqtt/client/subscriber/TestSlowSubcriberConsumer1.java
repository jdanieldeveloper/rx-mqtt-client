 ...
 */
public class TestSlowSubcriberConsumer1 implements MessageConsumer<MessageWrapper> {

    private static final Logger logger = LoggerFactory.getLogger(TestSlowSubcriberConsumer1.class);
    ...
    public void accept(MessageWrapper message) {
        logger.info("[{}] Recepcion del message[{}] desde el topico [{}]",
                    TestSlowSubcriberConsumer1.class.getSimpleName(), new String(message.getPayload(), StandardCharsets.UTF_8), message.getTopicFilter());
