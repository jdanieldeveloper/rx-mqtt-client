 ...
 */
public class TestSubcriberConsumer implements MessageConsumer<MessageWrapper> {

    private static final Logger logger = LoggerFactory.getLogger(TestSubcriberConsumer.class);
    ...
    public void accept(MessageWrapper message) {
        logger.info("[{}] Recepcion del message[{}] desde el topico [{}]",
                    TestSubcriberConsumer.class.getSimpleName(), new String(message.getPayload(), StandardCharsets.UTF_8), message.getTopicFilter());
