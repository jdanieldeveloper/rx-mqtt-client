 ...
 * <p>
 * {@link MessageSubBus} tiene el proposito de consumir mensajes de los topicos subcritos a traves del
 ...
 */
public class MessageSubBus implements Bus {

    private static MessageSubBus mqttSubscriberBus;

    private static EmitterProcessor<Object> processor = EmitterProcessor.create();

    private static final Logger logger = LoggerFactory.getLogger(MessageSubBus.class.getCanonicalName());
