 ...
 * <p>
 * {@link TopicSubBus} tiene el proposito de consumir mensajes de los topicos subcritos a traves del
        ...
        processor
            .publish()
             ...
             .subscribe(subscriber, e -> {
                logger.error("[{}] Se ha producido un error en el flujo del subcriptor asincronico!!!", TopicSubBus.class.getSimpleName());
